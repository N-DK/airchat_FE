    ...
    return (
        ...
        >
            <div className="bg-white dark:bg-dark2Primary h-full">
                <div className="relative dark:bg-darkPrimary px-5 md:px-10 pt-12  flex justify-center items-center py-4 md:py-5 text-lg md:text-[19px] border-b-[1px] border-gray-300 dark:border-darkPrimary">
                    <button
                ...
                <div>
                    <div className="flex flex-col items-center justify-center mt-3">
                        <p className="text-lg md:text-[19px] dark:text-white">
                            Your friends's profile will show you invited them
                        </p>
                    </div>
                    <div className="flex justify-center pt-5 px-5 bg-transparent dark:bg-transparent pb-[18px]">
                    ...
                    <div className="flex flex-col items-center justify-center mt-3">
                        <p className="text-xl md:text-[19px] font-semibold mb-2 dark:text-white">
                            Add contacts
                        </p>
                        <p className="text-sm text-center md:text-[17px] text-gray-500 w-[50%] dark:text-white">
