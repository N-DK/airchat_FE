    ...
    >
      <div className="px-5 md:px-10 bg-white dark:bg-dark2Primary h-full rounded-t-3xl">
        <div className="flex justify-between items-center pt-9">
          ...
          <div>
            <h4 className="text-black dark:text-white">New Channel</h4>
          </div>
          <button onClick={() => checkContinueHandle()}>
            <h4
              className={`${
                isContinue
        ...
        <div className="mt-9">
          <p className="text-center text-lg text-zinc-500 dark:text-gray-400">
            Your channel will not be activated until at least 3 separate people
            pose into it
          </p>
        </div>

        <div className="mt-10">
          <h4 className="text-black dark:text-white">Channel Name</h4>
          <input
            type="text"
        ...
        <div className="mt-10">
          <h4 className="text-black dark:text-white">Channel Photo</h4>
          <label htmlFor="file_input" className="inline-block">
            {!file ? (
              <div className="mt-3 flex justify-center items-center bg-grayPrimary h-[70px] md:h-[120px] w-[70px] md:w-[120px] rounded-2xl">
                <IoIosAdd size="4rem" className="text-zinc-400 p-2" />
              </div>
            ) : (
              <img
                src={file}
          ...
          <input onChange={handleChange} hidden type="file" id="file_input" />
        </div>
      </div>
    </div>
  );
